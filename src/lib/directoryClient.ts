...
export interface DirectoryWrite { collection: DirectoryCollection; id: string; operation: 'set' | 'delete'; data?: Record<string, unknown>; expectedDefinition?: import('./customFields').CustomFieldDefinition | null; expectedCustomMetadata?: Record<string, unknown> }
...
export async function commitDirectory(user: SessionUser, writes: DirectoryWrite[], audit: DirectoryAudit) {
